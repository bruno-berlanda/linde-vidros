...
<?php
$consulta = mysqli_query ($conexao, "SELECT data, nome, descricao, arquivo, aviso_envio FROM arquivos WHERE categoria='N' AND ativo='S' ORDER BY nome") or die (mysqli_error());
        ...
        <div class="col-sm-12 col-md-3">
            <div class="thumbnail" id="materiais">
                ...
                <div class="caption">
                	...
                	<p><a href="materiais/normas/<?php echo $arquivo; ?>" class="btn btn-success btn-block" target="_blank" role="button"<?php if ($aviso_envio == "S") { echo " onClick=\"return confirm('ATENÇÃO! Não envie esse arquivo para o cliente. Este documento serve apenas para consulta do vendedor.')\""; } ?>><i class="fas fa-search"></i> Visualizar</a></p>
                    <div class="row">
                    	<div class="col-xs-6">
                        	<?php
