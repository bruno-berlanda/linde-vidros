...
/* Tag Google */
$con_tag = mysqli_query ($conexao, "SELECT vidro_extraclear AS tag FROM admin_tags WHERE id='1'") or die (mysqli_error());
...
$og_url = "http://www.lindevidros.com.br/vidro-extra-clear";
...
<div class="container">
    <div class="row" id="img-pg">
    	<div class="col-md-12">
        	<img src="img/img_extra_clear.jpg" alt="Vidro Extra Clear" class="img-rounded img-responsive">
        </div>
    </div>
    	...
    	<div class="col-md-12">
            ...
            <div class="row">
                <div class="col-xs-4 col-md-2">
                    <a href="img/produtos/grande/extraclear1.jpg" rel="shadowbox[vocation]" title="Vidro Extra Clear" class="thumbnail">
                    <img src="img/produtos/miniatura/extraclear1.jpg" alt="Vidro Extra Clear">
                    </a>
                </div>
                <div class="col-xs-4 col-md-2">
                    <a href="img/produtos/grande/extraclear2.jpg" rel="shadowbox[vocation]" title="Vidro Extra Clear" class="thumbnail">
                    <img src="img/produtos/miniatura/extraclear2.jpg" alt="Vidro Extra Clear">
                    </a>
                </div>
            </div>
        </div>
