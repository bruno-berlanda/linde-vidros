...
$cadastra = mysqli_query ($conexao, "INSERT INTO produtos_ferragens 
...
header ('Location: ../produtos_ferragens.php?msgSucesso=Ferragem cadastrada com sucesso');
...
if (is_file($_FILES['foto1']['tmp_name']) || is_file($_FILES['foto2']['tmp_name'])) {
	$con_fotos = mysqli_query ($conexao, "SELECT imagem1, imagem2 FROM produtos_ferragens WHERE id='$id'") or die (mysqli_error());
...
if (is_file($_FILES['foto1']['tmp_name'])) {
	$atualiza1 = mysqli_query ($conexao, "UPDATE produtos_ferragens SET imagem1='$arquivo1_upload' WHERE id='$id'") or die (mysqli_error());
}
if (is_file($_FILES['foto2']['tmp_name'])) {
	$atualiza2 = mysqli_query ($conexao, "UPDATE produtos_ferragens SET imagem2='$arquivo2_upload' WHERE id='$id'") or die (mysqli_error());
}

	$atualiza3 = mysqli_query ($conexao, "UPDATE produtos_ferragens SET cod='$codigo', descricao='$descricao', peso='$peso', cor_bz='$cor_bz', cor_pt='$cor_pt', cor_cr='$cor_cr', cor_bc='$cor_bc', cor_nf='$cor_nf', cor_mf='$cor_mf', cor_mg='$cor_mg' WHERE id='$id'") or die (mysqli_error());
		
header ('Location: ../produtos_ferragens.php?editar='.$id.'&msgSucesso=Ferragem atualizada com sucesso');
...
$atualiza = mysqli_query ($conexao, "UPDATE produtos_ferragens SET ativo='N' WHERE id='$id'") or die (mysqli_error());

header ('Location: ../produtos_ferragens.php?msgSucesso=Ferragem desativada com sucesso');
...
$atualiza = mysqli_query ($conexao, "UPDATE produtos_ferragens SET ativo='S' WHERE id='$id'") or die (mysqli_error());

header ('Location: ../produtos_ferragens.php?msgSucesso=Ferragem ativada com sucesso');
...
$excluir = mysqli_query ($conexao, "DELETE FROM produtos_ferragens WHERE id='$id'") or die (mysqli_error());
		
header ('Location: ../produtos_ferragens.php?msgSucesso=Ferragem excluída com sucesso');
