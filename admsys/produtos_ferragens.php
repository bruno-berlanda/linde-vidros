...
-----------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------- -->
<form method="post" action="funcoes/produtos_ferragens.php?funcao=cadastrar" enctype="multipart/form-data" class="form-horizontal">
    <fieldset>
        <legend>Cadastrar Ferragem</legend>
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-sm-9">
            	<div class="checkbox">
                    <label>
                    	<input type="checkbox" name="cor_bz" value="S" checked> Bronze
                    </label>
                </div>
                <div class="checkbox">
                    <label>
                    	<input type="checkbox" name="cor_pt" value="S" checked> Preto
                    </label>
                </div>
                <div class="checkbox">
                    <label>
                    	<input type="checkbox" name="cor_cr" value="S" checked> Cromado
                    </label>
                </div>
                <div class="checkbox">
                    <label>
                    	<input type="checkbox" name="cor_bc" value="S" checked> Branco
                    </label>
                </div>
                <div class="checkbox">
                    <label>
                    	<input type="checkbox" name="cor_nf" value="S" checked> Natural Fosco
                    </label>
                </div>
                <div class="checkbox">
                    <label>
...
<?php
	...
	$consulta = mysqli_query ($conexao, "SELECT * FROM produtos_ferragens WHERE id='$id'") or die (mysqli_error());
...
-----------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------- -->
<form method="post" action="funcoes/produtos_ferragens.php?funcao=editar&id=<?php echo $id; ?>" enctype="multipart/form-data" class="form-horizontal">
    <fieldset>
        <legend>Editar Ferragem</legend>
        ...
        <div class="form-group form-group-sm">
            <div class="col-sm-offset-3 col-sm-9">
            	<button type="submit" class="btn btn-primary">Salvar</button>
                <a href="produtos_ferragens.php" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </fieldset>
</form>
...
<div class="row">
	<div class="col-xs-6">
    	<?php if ($imagem1 != "") { ?>
        <img src="../img/produtos/ferragens/<?php echo $imagem1; ?>" class="img-responsive img-thumbnail">
        <?php } ?>
    </div>
    <div class="col-xs-6">
    	<?php if ($imagem2 != "") { ?>
        <img src="../img/produtos/ferragens/<?php echo $imagem2; ?>" class="img-responsive img-thumbnail">
        <?php } ?>
    </div>
</div>
...
$consulta = mysqli_query ($conexao, "SELECT * FROM produtos_ferragens ORDER BY cod") or die (mysqli_error());
...
?>
    	...
    	<tr>
			...
			if ($ativo == "S") {
			?>
            <a href="funcoes/produtos_ferragens.php?funcao=desativar&id=<?php echo $id; ?>" class="btn btn-xs btn-block btn-success"><i class="fas fa-thumbs-up"></i></a>
            <?php
			} else if ($ativo == "N") {
			?>
            <a href="funcoes/produtos_ferragens.php?funcao=ativar&id=<?php echo $id; ?>" class="btn btn-xs btn-block btn-default"><i class="fas fa-thumbs-down"></i></a>
            <?php
			}
			?>
            </td>
            ...
            <td>
            <a href="produtos_ferragens.php?editar=<?php echo $id; ?>" class="btn btn-xs btn-block btn-warning"><i class="fas fa-pencil-alt"></i></a>
            </td>
            
            <td>
			<?php if ($perm_adm == "S") { ?>
            <a href="funcoes/produtos_ferragens.php?funcao=excluir&id=<?php echo $id; ?>" class="btn btn-xs btn-block btn-danger" onClick="return confirm('Tem certeza que deseja excluir o produto <?php echo $cod; ?>?')"><i class="fas fa-trash-alt"></i></a>
            <?php } else { ?>
