            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br><br>
                        <a href="ftp://ftp.adobe.com/pub/adobe/reader/win/11.x/11.0.10/en_US/AdbeRdr11010_en_US.exe" target="_blank" class="btn btn-block btn-primary"><i class="fas fa-download"></i> Download Adobe Reader</a>
                        </div>
                    </div>
                </div>
                
                <div class="well">
                    <p class="text-center"><i class="fas fa-print fa-4x"></i></p>
                    
                    <a href="../croquis/branco.pdf" class="btn btn-success btn-block" target="_blank"><i class="fas fa-save"></i> Croqui em Branco</a>
                </div>
            </div>
