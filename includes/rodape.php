        	...
        	<div class="container">
            	<div class="row">
                    <div class="col-sm-4">
                        ...
                        <ul>
                        	<li><a href="<?php echo $l_curcadastrar; ?>" title="Trabalhe Conosco">Cadastrar Currículo</a></li>
                            <li><a href="<?php echo $l_curentrar; ?>" title="Trabalhe Conosco">Acessar Currículo</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-5">
                        <br class="visible-xs">
