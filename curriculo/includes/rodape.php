...
<footer>
	<p class="text-center"><img src="../img/linde.png" alt="Linde Vidros"></p>
    ...
    <address>
        <center>
        <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <a href="mailto:linde@lindevidros.com.br">linde@lindevidros.com.br</a>
        </center>
    </address>
