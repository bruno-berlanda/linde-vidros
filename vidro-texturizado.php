...
/* Tag Google */
$con_tag = mysqli_query ($conexao, "SELECT vidro_texturizado AS tag FROM admin_tags WHERE id='1'") or die (mysqli_error());
...
$og_url = "http://www.lindevidros.com.br/vidro-texturizado";
...
<div class="container">
    <div class="row" id="img-pg">
    	<div class="col-md-12">
        	<img src="img/img_texturizado.jpg" alt="Vidro Texturizado" class="img-rounded img-responsive">
        </div>
    </div>
        ...
        <div class="col-md-9">
			...
			<div class="row">
                <div class="col-xs-6 col-md-3">
                    <a href="img/produtos/grande/texturizado_pontilhado1.jpg" rel="shadowbox[vocation]" title="Vidro Pontilhado" class="thumbnail">
                    <img src="img/produtos/miniatura/texturizado_pontilhado1.jpg" alt="Vidro Pontilhado">
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <a href="img/produtos/grande/texturizado_squadriglass1.jpg" rel="shadowbox[vocation]" title="Vidro Squadriglass" class="thumbnail">
                    <img src="img/produtos/miniatura/texturizado_squadriglass1.jpg" alt="Vidro Squadriglass">
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <a href="img/produtos/grande/texturizado_miniboreal1.jpg" rel="shadowbox[vocation]" title="Vidro Mini Boreal" class="thumbnail">
                    <img src="img/produtos/miniatura/texturizado_miniboreal1.jpg" alt="Vidro Mini Boreal">
                    </a>
                </div>
            </div>
        </div>
