...
/* Tag Google */
$con_tag = mysqli_query ($conexao, "SELECT aluminios_detalhes AS tag FROM admin_tags WHERE id='1'") or die (mysqli_error());
...
$consulta_produto = mysqli_query ($conexao, "SELECT * FROM produtos_aluminios WHERE cod='$produto' AND ativo='S'") or die (mysqli_error());
            ...
            <div class="row">
                ...
                <div class="col-md-4">
            		<div class="row">
                    	<?php if ($p_img1 != "") { ?>
                        <div class="col-xs-12">
                        	<a href="img/produtos/aluminios/<?php echo $p_img1; ?>" rel="shadowbox[vocation]" title="<?php echo $p_codigo; ?>"><img src="img/produtos/aluminios/<?php echo $p_img1; ?>" class="img-thumbnail" alt="<?php echo $p_codigo; ?>"></a>
                        </div>
                        <?php } ?>
                        <?php if ($p_img2 != "") { ?>
                        <div class="col-xs-12">
                        	<a href="img/produtos/aluminios/<?php echo $p_img2; ?>" rel="shadowbox[vocation]" title="<?php echo $p_codigo; ?>"><img src="img/produtos/aluminios/<?php echo $p_img2; ?>" class="img-thumbnail" alt="<?php echo $p_codigo; ?>"></a>
                        </div>
                        <?php } ?>
                    </div>
            	</div>
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <?php echo $p_peso_x; ?>
                    <p><small class="text-muted">PESO REFERENTE A BARRA DE 6 METROS.</small></p>
                    <?php
					}
					?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="alert alert-warning alert-dismissible text-center" role="alert">
                        ...
                        <br><br>
                        <a href="acessorios-aluminios.php" title="Ferragens" class="alert-link">Volte para os Alumínios e selecione outro produto</a>
                    </div>
                </div>
            </div>
